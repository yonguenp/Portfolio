...
namespace SandboxPlatform.SAMANDA
{
    public class SAMANDA : MonoBehaviour
    {
        ...
        [SerializeField] private string GOOGLECLIENT_ID = "42582970021-5m5n3air4oedvkju5ckl7lgd00plaqr8.apps.googleusercontent.com";
        [SerializeField] private string PRODUCT_ID = "WTSCAm";
