...
{
    public class DiceEventDiceLayer : TabLayer , EventListener<DiceUIEvent>
    {
        [SerializeField]
        List<SubLayerInfoData> subLayerList = new List<SubLayerInfoData>();

        [SerializeField] GameObject subFirstTabReddot = null;
        [SerializeField] GameObject subSecondTabReddot = null;
        ...
        {
            if (subFirstTabReddot == null)
                return;

            subFirstTabReddot.SetActive(DiceEventPopup.GetDiceBoardReddotCondition());
            subSecondTabReddot.SetActive(DiceEventPopup.GetDiceQuestReddotCondition());
        }
    }
}