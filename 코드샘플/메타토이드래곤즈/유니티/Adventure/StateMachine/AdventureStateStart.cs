...
{
    public class AdventureStateStart : AdventureState, EventListener<UIBattleObjectEndEvent> //드래곤 생성 및 연출 및 대기
    {
        ...
        public void OnEvent(UIBattleObjectEndEvent eventType)
        {
            if(Data != null)
                ...
                Time.timeScale = PlayerPrefs.GetFloat("AdventureSpeed", 1.0f);
