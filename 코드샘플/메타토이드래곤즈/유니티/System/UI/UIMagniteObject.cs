...
{
    public class UIMagniteObject : UIObject, EventListener<UserStatusEvent>
    {
        [SerializeField]
        ...
        public override void InitUI(eUIType targetType)
        {
            ...
            StopAllCoroutines();
            lastestMagnite = User.Instance.UserData.Magnite;
        ...
        private void OnEnable()
        {
            ...
            var coin = User.Instance.UserData.Magnite;
            var distance = coin - lastestMagnite;
            if (distance != 0)
            {
        ...
        void RefreshCoinCount()
        {
            ...
            {
                coinAmountLabel.text = SBFunc.CommaFromNumber(User.Instance.UserData.Magnite);
            }
        ...
        public void OnEvent(UserStatusEvent eventType)
        {
            ...
            {
                case UserStatusEvent.eUserStatusEventEnum.MAGNITE:
                    RefreshCoinCount();
                    break;
            }
        }
