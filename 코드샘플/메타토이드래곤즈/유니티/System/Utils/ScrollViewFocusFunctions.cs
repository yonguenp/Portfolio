...
namespace SandboxNetwork
{
	public static class ScrollViewFocusFunctions
	{
		...
		public static void FocusOnItem(this ScrollRect scrollView, RectTransform item, float movingTime)
		{
			scrollView.DONormalizedPos(scrollView.CalculateFocusedScrollPosition(item), movingTime);
