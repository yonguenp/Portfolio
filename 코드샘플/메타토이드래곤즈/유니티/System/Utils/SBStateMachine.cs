...
namespace SandboxNetwork
{
    ...
    /// </summary>
    public class SBStateMachine<T> : ISBStateMachine where T : struct, IComparable, IConvertible, IFormattable
	{
		...
		public SBStateMachine(GameObject target, bool triggerEvents)
		{
			this.Target = target;
		...
		public virtual void ChangeState(T newState)
		{
			...
			if (TriggerEvents)
			{
				EventManager.TriggerEvent(new SBStateChangeEvent<T>(this));
			}
		}
	...
	public struct SBStateChangeEvent<T> where T : struct, IComparable, IConvertible, IFormattable
	{
		public GameObject Target;
		public SBStateMachine<T> TargetStateMachine;
		public T NewState;
		public T PreviousState;

		public SBStateChangeEvent(SBStateMachine<T> stateMachine)
		{
	...
	/// </summary>
	public interface ISBStateMachine
	{
