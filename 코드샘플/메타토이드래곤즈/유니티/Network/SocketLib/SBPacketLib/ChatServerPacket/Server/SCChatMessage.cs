...
namespace SBPacketLib
{
    ...
    public class SCChatMessage
    {
        ...
        {
            return @$"SCChatMessage chatType: {this.ChatType}, server: {this.ServerTag}, sender: {this.SendUserUID}, senderName: {this.SendUserName}, senderIcon: {this.SendIcon}
