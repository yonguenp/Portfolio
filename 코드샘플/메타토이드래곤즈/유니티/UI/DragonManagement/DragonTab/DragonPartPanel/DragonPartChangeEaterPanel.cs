...
{
    public class DragonPartChangeEaterPanel : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        DragonPartIconPanel partIconPanel = null;
        ...
        void ShowTradePartPopup(int slotIndex)
        {
            SystemPopup.OnSystemPopup(StringData.GetStringByIndex(100000248), StringData.GetStringByIndex(100002045),
                () => {
