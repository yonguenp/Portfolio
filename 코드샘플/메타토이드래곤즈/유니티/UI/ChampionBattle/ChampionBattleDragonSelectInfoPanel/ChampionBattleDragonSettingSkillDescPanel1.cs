...
{
    public class ChampionBattleDragonSettingSkillDescPanel1 : ChampionBattleDragonSettingSubPanel
    {
        [SerializeField]
        Text skillName = null;
        [SerializeField]
        ...
        void SetLabel()
        {
            ...
            int skillLevel = 1;
            var currentDragonData = PopupManager.GetPopup<ChampionBattleDragonSelectPopup>().Dragon;
