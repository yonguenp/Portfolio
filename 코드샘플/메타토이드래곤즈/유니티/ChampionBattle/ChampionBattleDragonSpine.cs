...
{
    public class ChampionBattleDragonSpine : BattleDragonSpine
    {
        public ChampionBattleDragonData AData
        {
            get { return Data as ChampionBattleDragonData; }
        ...
        {
            base.SetData(data);
            AData = data as ChampionBattleDragonData;
        }
        ...
        protected override void RandomAnimationFrame()
        {
            if (skeletonAni != null)
                skeletonAni.Update(0.0f);
        }
    }
}