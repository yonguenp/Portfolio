...
public class ChuseokAttendancePanel : MonoBehaviour
{
    ...
    public void SetAttendanceUI()
    {
        ...
        chuseok_event.chuseok_attendance attendanceData = null;
        ...
        foreach (neco_event_thanks_attendance attendance in neco_event_thanks_attendance.GetNecoAttendanceList())
        {
